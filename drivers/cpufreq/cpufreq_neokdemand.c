 ...
 */
#define DEFAULT_SAMPLE_RATE_JIFFIES 11
 ...
 */
#define DEFAULT_RAMP_UP_STEP 368000
 ...
 */
#define DEFAULT_MIN_CPU_LOAD 42
...
static int __init cpufreq_neokdemand_init(void)
{
	...
	up_wq = alloc_workqueue("kneokdemand_up", WQ_HIGHPRI, 1);
	down_wq = alloc_workqueue("kneokdemand_down", 0, 1);
	if (!up_wq || !down_wq)
		return -ENOMEM;
